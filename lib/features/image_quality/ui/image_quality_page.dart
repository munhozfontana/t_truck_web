...
import 'image_quality_controller.dart';

class ImageQualityPage extends GetView<ImageQualityController> {
  const ImageQualityPage({Key? key}) : super(key: key);
      ...
      listTableCardItem: controller.list
          .map(
            (element) => TableCardItem(
              ...
              title: element.name,
              leading: Text('${element.percent} - ${element.badQuality}'),
